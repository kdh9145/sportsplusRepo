...
<div id="content" class="container">
    <div class="row">
        <div class="col">
        	...
        	<form name="writeArticleForm" id="writeArticleForm" action="newsUpdateProcess" method="post" class="row">
        		<div class="col rounded bg-white shadow-sm p-5">

        			<div class="row">
	        			<div class="col">
		        			<h2 class="fw-bold">기사 수정</h2>
						</div>
						<div class="col text-end mb-3" id="topSubmit">
							...
							<input type="submit" value="수정하기" class="btn btn-dark btn-lg" id="articleSumbit">
						</div>
					</div>
	        		...
	        		<div class="row">
						<div class="col form-floating">
							<input type="text" class="form-control shadow-none border border-secondary-subtle" id="articleTitle" placeholder="" name="title" value="${news.title}">
						...
						<div class="col">
							<div class="d-flex">
								<div class="col border-start border-bottom p-3" style="width: 67%;">
									<div id="articleContent" contenteditable="true" style="min-height : 50vh;">${news.content}</div>
								</div>
